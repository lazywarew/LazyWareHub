...
if autoheal == true and game:GetService('Players').LocalPlayer.Status.Health.Value<100 and  game:GetService('Players').LocalPlayer.Status.Downed.Value~=true then
pcall(function()
