...
local toxicwords = {"nv is obese","nv is skid","new age on top","tightstudios on top  | gg/bcT9w8r","nice anti cheat","jeeper creeper sends his regards","L "..skiduser}
...
if v.Name ~=me.Name and v.Status.IsDead.Value ~= true  and integritytable.staminaAvailable == true and inventorytable.itemDrawn~=nil   then
  ...
  misctable.request("damage",v,coolstring,inventorytable.itemDrawn.name,true)
...
animation.AnimationId = "rbxassetid://" ..usebandageanimationid
